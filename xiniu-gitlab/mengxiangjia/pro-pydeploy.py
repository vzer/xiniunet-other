...
import datetime
import subprocess
from config import ProduceServiceIp as ServiceIp
from config import ProduceWebIp as WebIp
from config import ProduceJobIp as JobIp
from config import user,password
from config import proserviceLocalPath as serviceLocalPath
from config import proserviceScriptFile as serviceScriptFile
from config import prowebScriptFile as webScriptFile
from config import prowebLocalPath as webLocalPath
from config import projobLocalPath as jobLocalPath
from config import projobScriptFile as jobScriptFile
